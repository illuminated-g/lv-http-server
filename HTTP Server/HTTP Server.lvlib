	...
	<Item Name="_Private" Type="Folder">
		...
		<Item Name="Data Types" Type="Folder">
			<Item Name="Maps" Type="Folder">
				<Item Name="Complete Handler Map.ctl" Type="VI" URL="../Complete Handler Map.ctl"/>
				<Item Name="Connection Handler Map.ctl" Type="VI" URL="../Connection Handler Map.ctl"/>
				<Item Name="Controller Handler Map.ctl" Type="VI" URL="../Controller Handler Map.ctl"/>
				<Item Name="Controller Map.ctl" Type="VI" URL="../Controller Map.ctl"/>
				<Item Name="Exception Handler Map.ctl" Type="VI" URL="../Exception Handler Map.ctl"/>
				<Item Name="Request Handler Map.ctl" Type="VI" URL="../Request Handler Map.ctl"/>
				<Item Name="Response Handler Map.ctl" Type="VI" URL="../Response Handler Map.ctl"/>
				<Item Name="Route Handler Map.ctl" Type="VI" URL="../Route Handler Map.ctl"/>
			</Item>
